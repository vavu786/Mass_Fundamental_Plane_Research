...
def main():
    ...
    """choices = input("Which plots would you like to see? \n"
                    "1. Mass fundamental plane (separate)\n"
                    "2. Mass fundamental plane (combined)\n"
                    "3. Mass-size and mass-v-disp relations\n"
                    "4. Surface density-size relation\n"
                    "5. DM fraction-mass relation\n"
